...
public class Spline {
  ...
  public static boolean reticulateSplines(double x0, double y0, double theta0,
    ...
    double theta0_hat = MathStuff.getDifferenceInAngleRadians(
            result.theta_offset_, theta0);
    double theta1_hat = MathStuff.getDifferenceInAngleRadians(
    ...
    if (Math.abs(MathStuff.getDifferenceInAngleRadians(theta0_hat,
            theta1_hat))
            >= Math.PI / 2) {
      return false;
    }
